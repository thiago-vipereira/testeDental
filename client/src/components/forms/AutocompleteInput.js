...
const propTypes = {
	/** This is an object containing all the props that are necessary for the input to render properly. Read the Autocomplete for more information */
...
function AutocompleteInput({ inputProps }) {
