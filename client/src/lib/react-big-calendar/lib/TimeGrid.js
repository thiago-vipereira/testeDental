...
var TimeGrid = function (_Component) {
  ...
  function TimeGrid(props) {
    ...
    _this.checkOverflow = function () {
      ...
      if(_this.refs.content){ isOverflowing = _this.refs.content.scrollHeight > _this.refs.content.clientHeight};
  ...
  var prevView = null;
  TimeGrid.prototype.componentDidUpdate = function componentDidUpdate(prevProps, prevState) {
