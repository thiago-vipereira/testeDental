...
var _ResizableDayEvent = require('./ResizableDayEvent');

var _ResizableDayEvent2 = _interopRequireDefault(_ResizableDayEvent);
  ...
  var DragAndDropCalendar = function (_React$Component) {
    ...
    DragAndDropCalendar.prototype.render = function render() {
      ...
      props.components = _extends({}, components, {
        ...
        day: { event: resizable && _ResizableDayEvent2.default },
